...
## 1. Identificação e escopo do levantamento
...
| Oficial Registradora | Márcia Maria da Silva Costa Teixeira |
| Comarca / Distrito | Comarca de Goianápolis / Distrito Judiciário de Terezópolis |
| Estado | Goiás |
| PROAD | Nº 202509000672377 |

### 1.2. Escopo do diagnóstico

Este Relatório registra o levantamento inicial do acervo de Registro de Imóveis, com o objetivo de:

a) Subsidiar o preenchimento dos campos `[a apurar]` do Plano de Ação (Anexo I);  
b) Identificar volumes e situação do acervo (livros, matrículas, transcrições, indicadores);  
c) Mapear imóveis georreferenciados para priorização da inserção no SIG-RI;  
d) Identificar principais pendências de saneamento;  
e) Registrar limitações atuais e definir próximos passos.

### 1.3. Período abrangido
...
1. Consulta aos livros físicos e digitais do Registro de Imóveis
2. Consulta ao sistema de automação Engegraph (relatórios gerenciais)
3. Consulta ao Livro de Protocolo (totais de atos por período)
4. Consulta aos Indicadores Real e Pessoal
5. Verificação das matrículas com averbação de georreferenciamento ou memorial descritivo com coordenadas geodésicas
6. Consulta ao SIGEF/INCRA para imóveis rurais certificados na circunscrição
7. Entrevistas com serventuários do Registro de Imóveis
8. Análise de amostragem das matrículas para identificação de pendências típicas
...
## 4. Levantamento do acervo

### 4.1. Livros de registro
...
## 6. Situação das pendências de saneamento
...
## 7. Atos registrais correntes (após 01/09/2025)
...
1. O levantamento diagnóstico completo depende do acesso ao Engegraph e dos livros físicos, a ser realizado pelo responsável designado.
2. Dados parciais de matrículas foram obtidos via extração sanitizada local — não refletem necessariamente o acervo completo.
3. A integração automática do Engegraph com o IERI-e ainda não está confirmada.
4. O credenciamento de profissional técnico habilitado para o SIG-RI ainda está em avaliação.
5. O envio retroativo dos atos de set/2025 a abr/2026 está condicionado ao procedimento a ser confirmado com o ONR.
